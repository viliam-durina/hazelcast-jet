...
public class ExecutionContextImpl implements ExecutionContext {
    ...
    public ExecutionContextImpl(NodeEngine nodeEngine, TaskletExecutionService taskletExecService,
    ...
    public ExecutionContextImpl initialize(ExecutionPlan plan) {
    ...
    @Override
    public void handlePacket(byte[] packet, Address sender) throws IOException {
        BufferObjectDataInput in = createObjectDataInput(nodeEngine, packet);
