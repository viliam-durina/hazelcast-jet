...
public final class JetFilterIntoScanLogicalRule extends RelOptRule {

    public static final RelOptRule INSTANCE = new JetFilterIntoScanLogicalRule();

    private JetFilterIntoScanLogicalRule() {
        super(
                operand(Filter.class, operand(TableScan.class, any())), RelFactories.LOGICAL_BUILDER,
                JetFilterIntoScanLogicalRule.class.getSimpleName()
        );
    }
    ...
    public void onMatch(RelOptRuleCall call) {
        ...
        RexNode oldFilter;
        if (scan instanceof ConnectorScanLogicalRel) {
            ConnectorScanLogicalRel scan0 = (ConnectorScanLogicalRel) scan;
        ...
        ConnectorScanLogicalRel newScan = new ConnectorScanLogicalRel(
                scan.getCluster(),
